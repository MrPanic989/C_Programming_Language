...
Note:
Check inside the function if the number of elements to set is larger than the number
of elements of the vetor/matrix.
Dont forget to include #include <stdarg.h>
*/
#include <stdarg.h>
#include <stdio.h>
#include <stdlib.h>
